...
(function ($) {
  ...
  $('#comment-form').submit(function () {
    ...
    $('#comment-form-submit').html('<svg class="icon fa-spin" width="16px" height="16px"><use xlink:href="/images/icons.svg#icon-loading"></use></svg> &nbsp; Loading...');
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        showAlert('<strong>Thanks for your comment!</strong> It is <a href="https://github.com/jkeuper/jkeuper.github.io/pulls">currently pending</a> and will show on the site once approved.');
      },
      error: function (err) {
        console.log(err);
